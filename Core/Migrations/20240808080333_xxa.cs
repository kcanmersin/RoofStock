...
{
    public partial class xxa : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderProcessId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    ModifiedBy = table.Column<string>(type: "text", nullable: true),
                    DeletedBy = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("16ea936c-7a28-4c30-86a2-9a9704b6115e"), "21bcce4d-52a7-4105-8e7f-7463f589a5ed", "Superadmin", "SUPERADMIN" },
                    { new Guid("7cb750cf-3612-4fb4-9f7d-a38ba8f16bf4"), "64b03f6a-d750-4bf4-b0c4-7c4fa0119f6e", "Admin", "ADMIN" },
                    { new Guid("edf6c246-41d8-475f-8d92-41dddac3aefb"), "7ad5cf3d-08f4-4c1a-a9f5-ab1e81aaed91", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3aa42229-1c0f-4630-8c1a-db879ecd0427"), 0, "0a8a79ae-bc48-4eec-a457-2478f7c01bfe", "admin@gmail.com", false, "Admin", "API\\deflogo.jpg", "User", false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEEqaYtPdJyVP1eTmNyQvM/RMuWfMLB3gHCnwZSfGflmoyChKK3DnfNBcIoU9Qz1RQg==", "+905439999988", false, "dcf3e152-6d34-439f-8101-6c2e1b221b77", false, "admin@gmail.com" },
                    { new Guid("cb94223b-ccb8-4f2f-93d7-0df96a7f065c"), 0, "d9b30280-9ffc-45e1-af89-ab2474f764b1", "superadmin@gmail.com", true, "Can", "API\\deflogo.jpg", "Mersin", false, null, "SUPERADMIN@GMAIL.COM", "SUPERADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEFL2obK1uOj4m4Ms1v/TKHWK8kh29iN2+z421MjCrD9EsSRx6wk7t4eXNSnNlLNR3g==", "+905439999999", true, "86b90286-2d9c-483e-adf7-44af7363e39c", false, "superadmin@gmail.com" }
                });
